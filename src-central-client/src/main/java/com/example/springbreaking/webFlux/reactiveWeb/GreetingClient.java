...
//		return this.client.get().uri("/helloflux").accept(MediaType.APPLICATION_JSON) // HTTP 요청 준비
//				.retrieve().bodyToMono(GreetingFlux.class) // 응답처리
//				.map(GreetingFlux::getMessage); // 결과 반환
//	}
//
//}
